...
The number of goroutines  defaults to `runtime.GOMAXPROCS`. If the number of goroutine is equal to `GOMAXPROCS` and there're more functions to execute, these functions will wait until one of functions being executed finishes its job.
